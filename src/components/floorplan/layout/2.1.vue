    ...
    <div class="distribution">
      ...
      <div class="dis_content">
        <div class="areaC">
          <h3>C 区</h3>
          <ul>
            <li @click="show1">2.1C1-001</li>
            <li @click="show1">2.1C1-002</li>
            <li @click="show1">2.1C1-003</li>
            <li @click="show1">2.1C1-004</li>
            <li @click="show2" class="dangerous">2.1C1-005</li>
            <li @click="show1">2.1C1-006</li>
            <li @click="show1">2.1C1-007</li>
            <li @click="show1">2.1C1-008</li>
            <li @click="show1">2.1C1-009</li>
            <li @click="show1">2.1C2-010</li>
