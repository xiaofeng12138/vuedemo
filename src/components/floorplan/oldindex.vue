...
export default {
  data() {
    return {
      ZWall:{
        list1:[
          {PLACEPOSITION:'5.2A1-06'},
          {PLACEPOSITION:'5.2A2-04'},
          {PLACEPOSITION:'5.2B3-05'},
          {PLACEPOSITION:'5.2B6-03'},
        ],
        list2:[
          {PLACEPOSITION:'5.2A4-01'},
          {PLACEPOSITION:'5.2C1-08'},
        ],
        list3:[  
          {PLACEPOSITION:'5.2A1-01'},
        
        ],
        list4:[
          {PLACEPOSITION:'5.2B1-06'},
          {PLACEPOSITION:'5.2B1-01'},
          {PLACEPOSITION:'5.2B2-02'},
          {PLACEPOSITION:'5.2B2-01'},
          {PLACEPOSITION:'5.2A1-02'},
          {PLACEPOSITION:'5.2A4-01'},
          {PLACEPOSITION:'5.2A7-05'},
        ],
        list5:[
                  {
              "PLACEPOSITION":"5.2A0-01",
              "GWSTATUS":0,
              "STATUS":0,
              "ENTRYSTATUS":0,
              "GFXSTATUS":0,
